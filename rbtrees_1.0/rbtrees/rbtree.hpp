...
/**
  ...
  T _item;
  RBTNode<T>::Color _color;
  RBTNode<T>::Ref _parent;
  RBTNode<T>::Ref _left;
  RBTNode<T>::Ref _right;
...
protected:
  ...
  typename RBTNode<T>::Ref _root;
  typename RBTNode<T>::Ref _parent;
  typename RBTNode<T>::Ref _current;
  //
  Ref this_;
};
